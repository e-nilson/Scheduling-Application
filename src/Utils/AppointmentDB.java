...
public class AppointmentDB {
    ...
    public static void getAppointments() throws SQLException {
        ...
        while (rs.next()) {
            ...
            ListProvider.addAppointment(new Appointment(appointment_ID, title, description, location, type, start, end, contact_ID, customer_ID, user_ID));
        }
    }
    ...
    public static boolean updateAppointment(int appointment_ID, String title, String description, String location, String type, LocalDateTime start, LocalDateTime end, int contact_ID, int user_ID, int customer_ID) throws SQLException {
        ...
        //this is not the best practice. read about paramitized queries
